...
//!
        ...
        use zbus::proxy;
        #[proxy(interface = "org.fedoraproject.FirewallD1", default_service = "org.fedoraproject.FirewallD1", default_path = "/org/fedoraproject/FirewallD1")]
trait FirewallD1 {
    ...
    fn get_helper_settings(&self, helper: &str) -> zbus::Result<(String, String, String, String, String, Vec<(String, String)>)>;
    ...
    fn get_icmp_type_settings(&self, icmptype: &str) -> zbus::Result<(String, String, String, Vec<String>)>;
    ...
    fn get_service_settings(&self, service: &str) -> zbus::Result<(String, String, String, Vec<(String, String)>, Vec<String>, std::collections::HashMap<String, String>, Vec<String>, Vec<(String, String)>)>;

    /// getServiceSettings2 method
    #[zbus(name = "getServiceSettings2")]
    fn get_service_settings2(&self, service: &str) -> zbus::Result<std::collections::HashMap<String, zbus::zvariant::OwnedValue>>;

    /// getZoneSettings method
    #[zbus(name = "getZoneSettings")]
    #[allow(clippy::type_complexity)]
    fn get_zone_settings(&self, zone: &str) -> zbus::Result<(String, String, String, bool, String, Vec<String>, Vec<(String, String)>, Vec<String>, bool, Vec<(String, String, String, String)>, Vec<String>, Vec<String>, Vec<String>, Vec<String>, Vec<(String, String)>, bool)>;
