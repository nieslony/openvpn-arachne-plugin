...
//!
        ...
        use zbus::proxy;
        #[proxy(interface = "org.fedoraproject.FirewallD1.zone", default_service = "org.fedoraproject.FirewallD1", default_path = "/org/fedoraproject/FirewallD1")]
trait zone {

    /// addForwardPort method
    #[zbus(name = "addForwardPort")]
    #[allow(clippy::too_many_arguments)]
    fn add_forward_port(&self, zone: &str, port: &str, protocol: &str, toport: &str, toaddr: &str, timeout: i32) -> zbus::Result<String>;
    ...
    /// addPort method
    #[zbus(name = "addPort")]
    fn add_port(&self, zone: &str, port: &str, protocol: &str, timeout: i32) -> zbus::Result<String>;
    ...
    fn add_source_port(&self, zone: &str, port: &str, protocol: &str, timeout: i32) -> zbus::Result<String>;
    ...
    fn get_active_zones(&self) -> zbus::Result<std::collections::HashMap<String, std::collections::HashMap<String, Vec<String>>>>;
    ...
    fn get_zone_settings2(&self, zone: &str) -> zbus::Result<std::collections::HashMap<String, zbus::zvariant::OwnedValue>>;
    ...
    fn query_forward_port(&self, zone: &str, port: &str, protocol: &str, toport: &str, toaddr: &str) -> zbus::Result<bool>;
    ...
    fn remove_forward_port(&self, zone: &str, port: &str, protocol: &str, toport: &str, toaddr: &str) -> zbus::Result<String>;
    ...
    fn set_zone_settings2(&self, zone: &str, settings: std::collections::HashMap<&str, &zbus::zvariant::Value<'_>>) -> zbus::Result<()>;

    /// ForwardPortAdded signal
    #[zbus(signal)]
    fn forward_port_added(&self, zone: &str, port: &str, protocol: &str, toport: &str, toaddr: &str, timeout: i32) -> zbus::Result<()>;

    /// ForwardPortRemoved signal
    #[zbus(signal)]
    fn forward_port_removed(&self, zone: &str, port: &str, protocol: &str, toport: &str, toaddr: &str) -> zbus::Result<()>;
    ...
    #[zbus(signal)]
    fn source_port_added(&self, zone: &str, port: &str, protocol: &str, timeout: i32) -> zbus::Result<()>;
    ...
    /// ZoneUpdated signal
    #[zbus(signal)]
    fn zone_updated(&self, zone: &str, settings: std::collections::HashMap<&str, zbus::zvariant::Value<'_>>) -> zbus::Result<()>;
}
