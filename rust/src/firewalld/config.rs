...
//!
        ...
        use zbus::proxy;
        #[proxy(interface = "org.fedoraproject.FirewallD1.config", default_service = "org.fedoraproject.FirewallD1", default_path = "/org/fedoraproject/FirewallD1/config")]
trait config {

    /// addHelper method
    #[zbus(name = "addHelper")]
    fn add_helper(&self, helper: &str, settings: &(&str, &str, &str, &str, &str, &[&(&str, &str)])) -> zbus::Result<zbus::zvariant::OwnedObjectPath>;

    /// addIPSet method
    #[zbus(name = "addIPSet")]
    fn add_ipset(&self, ipset: &str, settings: &(&str, &str, &str, &str, std::collections::HashMap<&str, &str>, &[&str])) -> zbus::Result<zbus::zvariant::OwnedObjectPath>;

    /// addIcmpType method
    #[zbus(name = "addIcmpType")]
    fn add_icmp_type(&self, icmptype: &str, settings: &(&str, &str, &str, &[&str])) -> zbus::Result<zbus::zvariant::OwnedObjectPath>;

    /// addPolicy method
    #[zbus(name = "addPolicy")]
    fn add_policy(&self, policy: &str, settings: std::collections::HashMap<&str, &zbus::zvariant::Value<'_>>) -> zbus::Result<zbus::zvariant::OwnedObjectPath>;

    /// addService method
    #[zbus(name = "addService")]
    #[allow(clippy::type_complexity)]
    fn add_service(&self, service: &str, settings: &(&str, &str, &str, &[&(&str, &str)], &[&str], std::collections::HashMap<&str, &str>, &[&str], &[&(&str, &str)])) -> zbus::Result<zbus::zvariant::OwnedObjectPath>;

    /// addService2 method
    #[zbus(name = "addService2")]
    fn add_service2(&self, service: &str, settings: std::collections::HashMap<&str, &zbus::zvariant::Value<'_>>) -> zbus::Result<zbus::zvariant::OwnedObjectPath>;

    /// addZone method
    #[zbus(name = "addZone")]
    #[allow(clippy::type_complexity)]
    fn add_zone(&self, zone: &str, settings: &(&str, &str, &str, bool, &str, &[&str], &[&(&str, &str)], &[&str], bool, &[&(&str, &str, &str, &str)], &[&str], &[&str], &[&str], &[&str], &[&(&str, &str)], bool)) -> zbus::Result<zbus::zvariant::OwnedObjectPath>;

    /// addZone2 method
    #[zbus(name = "addZone2")]
    fn add_zone2(&self, zone: &str, settings: std::collections::HashMap<&str, &zbus::zvariant::Value<'_>>) -> zbus::Result<zbus::zvariant::OwnedObjectPath>;
    ...
    fn get_icmp_type_by_name(&self, icmptype: &str) -> zbus::Result<zbus::zvariant::OwnedObjectPath>;
