...
//!
        ...
        use zbus::proxy;
        #[proxy(interface = "org.fedoraproject.FirewallD1.config.policies", default_service = "org.fedoraproject.FirewallD1", default_path = "/org/fedoraproject/FirewallD1/config")]
trait policies {
    ...
    fn get_lockdown_whitelist(&self) -> zbus::Result<(Vec<String>, Vec<String>, Vec<String>, Vec<i32>)>;
    ...
    fn set_lockdown_whitelist(&self, settings: &(&[&str], &[&str], &[&str], &[i32])) -> zbus::Result<()>;
