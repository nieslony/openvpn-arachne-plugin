...
#ifndef __sdbuscpp__firewalld_proxy_sdbus_1_FirewallD1_Config_Proxy_h__proxy__H__
#define __sdbuscpp__firewalld_proxy_sdbus_1_FirewallD1_Config_Proxy_h__proxy__H__
...
protected:
    ...
    config_proxy(config_proxy&&) = default;
    config_proxy& operator=(config_proxy&&) = default;
...
public:
    ...
    {
        return proxy_->getProperty("IPv6_rpfilter2").onInterface(INTERFACE_NAME);
    }

    void IPv6_rpfilter2(const std::string& value)
    {
        proxy_->setProperty("IPv6_rpfilter2").onInterface(INTERFACE_NAME).toValue(value);
    }
    ...
    {
        return proxy_->getProperty("NftablesTableOwner").onInterface(INTERFACE_NAME);
    }

    void NftablesTableOwner(const std::string& value)
    {
        proxy_->setProperty("NftablesTableOwner").onInterface(INTERFACE_NAME).toValue(value);
    }
